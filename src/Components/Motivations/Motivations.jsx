      ...
      <FadeIn>
        ...
        <div className='mt-14 grid grid-cols-1 justify-between md:grid-cols-2'>
          <div className='mr-6 mb-14 md:mb-0 md:mr-20 max-w-5xl text-lg text-left  font-light'>
            ...
            eos praesentium soluta inventore, odio ipsum sapiente, quam iure
            totam harum labore doloribus cumque dicta amet saepe. <br /> <br />
            Assumenda in exercitationem minus doloribus deserunt officia,
            aperiam alias tempora repellat sequi est non illum laborum, vel ut!{" "}
            <br /> <br />
            Nihil deleniti asperiores architecto recusandae, maxime
            exercitationem mollitia obcaecati est numquam eos amet ab expedita
            rerum, unde ad similique consectetur velit?
            <br /> <br />
            ...
            Beatae qui praesentium labore aut harum porro cumque quis! Lorem
